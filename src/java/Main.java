    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (input) {
                ...
                case 2: {
                    insertPatronIntoDatabase();
                    break;
                }
                case 3: {
                    printBooksOlderThanQuery();
                    break;
                }
                case 4: {
                    printBooksNewerThanQuery();
                    break;
                }
                case 5: {
                    printBooksLikeTitleQuery();
                    break;
                }
                case 6: {
                    printBooksLikeAuthorQuery();
                    break;
                }
                case 7: {
                    printPatronsOlderThanQuery();
                    break;
                }
                case 8: {
                    printPatronsYoungerThanQuery();
                    break;
                }
                case 9: {
                    printPatronsAtZipCodeQuery();
                    break;
                }
                case 10: {
                    printPatronsAtStateCodeQuery();
                    break;
                }
                case 11: {
                    printPatronsAtCityQuery();
                    break;
                }
                case 12: {
                    printPatronsWithNameQuery();
                    break;
                }
            }
        } while (input != 0);
